...
function calc() {
  // Start calculate
  var calcCont = document.querySelector('.calculating'),
  ...
  function runCalc() {
    ...
    function setCalc() {
      ...
      if (height != "" && weight != "" && age != "" && !isNaN(height) && !isNaN(weight) && !isNaN(age)) {
        if (femaleBtn.classList.contains(activeClass)) {
          bmr = bmr * getActivity();
          totalCalloric = bmr + weightInput.value * 9.2 + heightInput.value * 3.1 - ageInput.value * 4.3; // BMR = 447,6 + (9,2 × вес в кг) + (3,1 × рост в см) – (4,3 × возраст в годах).
        } else if (maleBtn.classList.contains(activeClass)) {
          bmr = 88.36 * getActivity();
          totalCalloric = bmr + weightInput.value * 13.4 + heightInput.value * 4.8 - ageInput.value * 5.7; // BMR = 88,36 + (13,4 × вес в кг) + (4,8 × рост в см) – (5,7 × возраст в годах).
        }
    ...
    var setBtn = function setBtn(elements) {
      return function (e) {
        e.preventDefault();
    ...
    var chooseActive = document.querySelector('#gender').querySelectorAll(calcChose);
    femaleBtn.addEventListener('click', setBtn(chooseActive));
    maleBtn.addEventListener('click', setBtn(chooseActive));
    dataPerson.forEach(function (item) {
...
/* harmony import */ var _services_services__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../services/services */ "./Food/js/services/services.js");
...
function cards() {
  ...
  var MenuCard = /*#__PURE__*/function () {
    function MenuCard(src, alt, title, descr, price, transfer, selector) {
      ...
      for (var _len = arguments.length, addCLass = new Array(_len > 7 ? _len - 7 : 0), _key = 7; _key < _len; _key++) {
        addCLass[_key - 7] = arguments[_key];
      }
    ...
    _createClass(MenuCard, [{
      ...
      value: function getArr() {
        var arr = [this.src, this.alt, this.title, this.descr, this.price, this.transfer, this.selector, this.addCLass];
      ...
      key: "rendedr",
      value: function rendedr() {
        var div = document.createElement('div');

        if (this.addCLass.length == 0) {
          div.classList.add('menu__item');
        } else {
          this.addCLass.forEach(function (addClass) {
            return div.classList.add(addClass.slice(1));
          });
        }
  ...
  function createCard(data) {
    data.forEach(function (_ref) {
      var img = _ref.img,
          ...
          descr = _ref.descr,
          price = _ref.price,
          _ref$transfer = _ref.transfer,
          transfer = _ref$transfer === void 0 ? 28 : _ref$transfer;
      var div = document.createElement('div');
      div.classList.add('menu__item');
      div.innerHTML = "\n      <img src=\"".concat(img, "\" alt=\"").concat(altimg, "\">\n      <h3 class=\"menu__item-subtitle\">").concat(title, "</h3>\n      <div class=\"menu__item-descr\">").concat(descr, "</div>\n      <div class=\"menu__item-divider\"></div>\n      <div class=\"menu__item-price\">\n          <div class=\"menu__item-cost\">\u0426\u0435\u043D\u0430:</div>\n          <div class=\"menu__item-total\"><span>").concat(price * transfer, "</span> \u0433\u0440\u043D/\u0434\u0435\u043D\u044C</div>\n      </div>\n    ");
...
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modal */ "./Food/js/modules/modal.js");
/* harmony import */ var _services_services__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../services/services */ "./Food/js/services/services.js");
...
function form(modalSelector) {
  ...
  function showThanksModal(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_9__.showModal)(modalSelector);
    setTimeout(function () {
      thanksModal.remove();
      prevModalDialog.classList.toggle('hide');
      (0,_modal__WEBPACK_IMPORTED_MODULE_9__.hideModal)(modalSelector);
    }, 5000);
  } // End form		
...
function showModal(modalSelector, timerId) {
  ...
  document.body.style.overflow = "hidden"; // eventModal();
}
...
function modal(trigerSelector, modalSelector, timerId) {
  var modalBtns = document.querySelectorAll(trigerSelector),
      modalWindow = document.querySelector(modalSelector); // function eventModal() {

  var btnsClose = function btnsClose(e) {
    e = e.target;
  ...
  function addEventModal() {
    modalBtns.forEach(function (element) {
  ...
  var scrollModal = function scrollModal(e) {
...
function slider(_ref) {
  var sliderContainerSelect = _ref.sliderContainerSelect,
      prevBtnSelector = _ref.prevBtnSelector,
      nextBtnSelector = _ref.nextBtnSelector,
      currentNumSelector = _ref.currentNumSelector,
      totalNumSelector = _ref.totalNumSelector,
      sliderWrapSelector = _ref.sliderWrapSelector,
  ...
  var sliderContainer = document.querySelector(sliderContainerSelect),
  ...
  function setSliderWindow() {
    ...
    setPosition(currentN); //Added css and animation for slider

    var slideWrapperCss = "\n        display: flex;\n        position: relative;\n        width: ".concat(getWidth, "px;\n        transition: all .5s ease-in-out;\n      "),
        slideW = slides[0].offsetWidth;
    sliderContainer.style.cssText = "\n  overflow: hidden;\n  position: relative;\n"; //--------------------

    function setSlide() {
      var position = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : -(slideW * slidePos - slideW);
      sliderWrapper.style.cssText = "\n  ".concat(slideWrapperCss, "\n  left: ").concat(position, "px\n");
    }

    setSlide(0); // Create dots
    ...
    function setDots(slidePos) {
      document.querySelectorAll('.carousel-indicators .dot').forEach(function (element) {
    ...
    setDots(slidePos); // End Create dots
...
function tabs(containerSelector, menuItemSelector, contentItemsSelector, itemActiveSelector) {
  var tabsContainer = document.querySelector(containerSelector),
  ...
  function hideContentTabs() {
    tabMenueItems.forEach(function (item) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (tabs); // End Tabs
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (timer); // End Timer
...
/* harmony import */ var _modules_tabs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/tabs */ "./Food/js/modules/tabs.js");
...
/* harmony import */ var _modules_modal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/modal */ "./Food/js/modules/modal.js");
/* harmony import */ var _modules_cards__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/cards */ "./Food/js/modules/cards.js");
/* harmony import */ var _modules_form__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/form */ "./Food/js/modules/form.js");
...
/* harmony import */ var _modules_calc__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/calc */ "./Food/js/modules/calc.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__.default)('.timer', '2021-03-18');
  ...
  (0,_modules_form__WEBPACK_IMPORTED_MODULE_5__.default)('.modal');
...
/******/ 	// startup
/******/ 	// Load entry module
/******/ 	__webpack_require__("./Food/js/script.js");
